				...
				<ul class="" id="bxslider-home4">
					<li>
						...
						<div class="caption-group">
							...
							<h4 class="caption subtitle">NANO SIM</h4>
                                ...
                                <div class="single-product">
                                    <div class="product-f-image">
                                        ...
                                        <div class="product-hover">
                                            {{-- <a id="haha" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a> --}}
                                            <a href="{{ asset('detail') }}/{{$product->slug}}" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                        </div>
                                    </div>
